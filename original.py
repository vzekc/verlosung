...
if __name__ == '__main__':
    ...
    lottery = VzEkC(
        drawings=[
            {'text': 'Paket #1 SS2', 'names': ['@obsd_guru', '@tuti', '@Cobalt60', '@gnupublic']},
            {'text': 'Paket #2 SS10', 'names': ['@obsd_guru', '@tuti', '@Cobalt60', '@gnupublic']},
            {'text': 'Paket #3 V4K+Disks', 'names': ['@Hans', '@Schroeder', '@obsd_guru', '@gnupublic']},
            {'text': 'Paket #4 V4K', 'names': ['@Hans', '@Schroeder', '@obsd_guru', '@gnupublic']},
            {'text': 'Paket #5 NetApp', 'names': ['@Schroeder', '@obsd_guru']}
        ],
        # Zeitstempel aus dem ersten Beitrag des Kassenwarts nach dem Ende des Loskauf-Zeitraumes:
        post_timestamp='1737805920'
    )
    lottery.print_drawing()
